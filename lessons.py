...
physics_lesson_link = 'https://zoom.us/wc/join/96831626748?pwd=Q1ltKzljdmF2RVVHRDZGREFQdmNIZz09'
...
18:30-19:30: programming\n'''
        ...
        return '''\n08:45-9:30: history tsipi
9:30-10:15: torah rabinak
10:30-11:15: history itsik
12:30-14:00: physics
14:30-16:00: physics\n'''
    elif wednesday:
        return '''\n08:45-10:15: math
...
def which_lesson(lesson):
    ...
    lessons = {
        ...
        sunday and hour_min >= '12:57' and hour_min <= '14:00': math_lesson_link,
        ...
        # tuesday
        tuesday and hour_min >= '9:27' and hour_min < '10:15': torah_leeson_link_rabinak,
        tuesday and hour_min >= '10:27' and hour_min <= '11:15': history_lesson_link_itsik,
        ...
        # thursday
        thursday and hour_min >= '09:27' and hour_min <= '10:15': gemara_lesson_link,
